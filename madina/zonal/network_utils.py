    ...
    for position in ["start", "end"]:
        for edge_idx in geometry_gdf.index:
            ...
            for intersecting_point in current_intersecting_points:
                ...
                if edge_collector[intersecting_point_type][intersecting_point_segment_idx] != -1: ## already filled by another edge..
                    continue
                degree += 1
...
def _effecient_node_insertion(n_node_gdf: GeoDataFrame, n_edge_gdf: GeoDataFrame, source_gdf: GeoDataFrame, layer_name: str, label: str ="origin", weight_attribute: str =None):
